...
export const sendInviteLink = async (req, res) => {
    ...
    try {
        ...
        if (token) {
            ...
            let htmlBody = `
<h4>Estimado/a</h4>
<p>Le informamos que tiene una consulta médica remota programada. Por favor, ingrese a la <a href="${URL_FONT_APP}tele/meeting/remote?token=${token}">reunión</a> para conectarse con su médico.</p>
<p>Si tiene alguna duda o necesita más información, no dude en contactarnos.</p>
<p>Atentamente,<br>El equipo de Telemedicina</p>
`;
